<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="http://uqian.me" target="_blank">零钱购</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="http://iconfont.cn/repositories" target="_blank" rel="external nofollow">阿里巴巴矢量图标库</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" id="jsonapi" data-toggle="dropdown" style="color: red;" role="button" aria-haspopup="true" aria-expanded="false">
                        接口API<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a id="chargeapi" target="_blank" href="http://www.jisuapi.com/?hmsr=bejsonnav&hmpl=&hmcu=&hmkw=&hmci=" rel="external nofollow" style="color: red;">付费JSON接口</a></li>
                        <li><a href="/knownjson/webInterface/" id="findbyxpath">免费JSON接口</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" id="downloada" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a id="apliayapi" href="https://open.alipay.com/platform/document.htm" target="_blank" rel="external nofollow">支付宝开发文档</a></li>
                        <li role="separator" class="divider"></li>
                        ...
                        <li><a id="jqapi" href="http://www.jq22.com/chm/jquery1.8.3.html" target="_blank" rel="external nofollow">jQuery文档</a></li>
                        <li role="separator" class="divider"></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" id="testtools" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">第三方平台工具<span class="caret"></span></a>
                    <ul class="dropdown-menu">
