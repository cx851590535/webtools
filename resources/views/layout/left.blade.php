<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-list-alt fa-fw"></i> 格式化<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="/jshtml_format/">Javascript/HTML压缩、格式化</a></li>
                    <li><a href="/otherformat/css/">CSS压缩、格式化</a></li>
                    <li><a href="/otherformat/xml/">XML压缩、格式化</a></li>
                    <li><a href="/otherformat/sql/">SQL压缩、格式化</a></li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="http://runjs.cn/code" target="_blank" rel="external nofollow" id="runjs">RunJS在线编辑器</a>
                    </li>
                    ...
                    <li><a href="/ui/imageresize/" id="imgResize">在线图片大小缩放</a></li>
                    <li><a href="/ui/phonesize/" id="phonesize">iPhone/iPad/Android UI尺寸规范</a></li>
                    <li><a href="http://iconfont.cn/repositories" target="_blank" rel="external nofollow">阿里巴巴矢量图标库</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="/convert/unix/">Unix时间转换</a></li>
                    ...
                    <li><a href="/convert/qrcode/" id="qrtools">二维码生成与解码</a></li>
                    ...
                    <li><a href="/othertools/sql2pojo/" id="sql2pojo">数据库转实体类</a></li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="/othertools/regex/">正则表达式</a></li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a id="wxapi" href="http://mp.weixin.qq.com/wiki/home/index.html" target="_blank"
                           rel="external nofollow">微信公众平台开发文档</a></li>
                    <li><a id="wxapi" href="http://mp.weixin.qq.com/wiki/11/74ad127cc054f6b80759c40f77ec03db.html"
                           target="_blank" rel="external nofollow">微信JSSDK开发文档</a></li>
                    <li><a id="wxapi" href="https://pay.weixin.qq.com/wiki/doc/api/index.html" target="_blank"
                           rel="external nofollow">微信支付开发文档</a></li>
                    <li role="separator" class="divider"></li>
                    <li><a id="tbapi" href="http://open.taobao.com/api/api_list.htm?spm=a219a.7386789.1.27.Lf4YRD"
                           target="_blank" rel="external nofollow">淘宝开发文档</a></li>
                    <li><a id="apliayapi" href="https://open.alipay.com/platform/document.htm" target="_blank"
                           rel="external nofollow">支付宝开发文档</a></li>
                    <li role="separator" class="divider"></li>
                    <li><a id="baiduinterface" href="http://apistore.baidu.com/astore/classificationservicelist.html"
                           target="_blank" rel="external nofollow">百度API市场</a></li>
                    <li><a id="jqapi" href="http://www.jq22.com/chm/jquery1.8.3.html" target="_blank"
                           rel="external nofollow">jQuery文档</a></li>
                    <li role="separator" class="divider"></li>
